...
package ct326.assignment05;	//Use package "assignment3" as required
...
public class Rational implements Serializable {
	...
	public Rational (String fraction) throws Exception {
	...
	//A method to write the time into a file
	public void writeObject(ObjectOutputStream s) throws IOException {
		
		s.writeLong(System.currentTimeMillis());
	}
	
	//A method to read the time from a file
	public void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
		
		long time = s.readLong();
		System.out.println("The time that this was serialized was " + time + "\n");
	}
}
